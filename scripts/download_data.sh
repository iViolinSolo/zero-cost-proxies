###
 # @Author: ViolinSolo
 # @Date: 2023-04-07 19:36:53
 # @LastEditTime: 2023-04-07 19:38:00
 # @LastEditors: ViolinSolo
 # @Description: download_data.sh from naslib/scripts/bash_scripts/download_data.sh
 # @FilePath: /zero-cost-proxies/scripts/download_data.sh
### 
